...
expName = 'orient_discri'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\urmil\\OneDrive\\Desktop\\New folder\\sequentialLearning\\sequencial learning final_lastrun.py',
...
for thisTrial_3 in trials_3:
    ...
    trials = data.TrialHandler(nReps=50.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('C:/Users/urmil/OneDrive/Desktop/sequence.xlsx'),
    ...
    for thisTrial in trials:
        ...
        trialComponents = [polygon, line1, line2, line3, line4, probe, key_resp]
